...
static const char qt_meta_stringdata_SetVehicleNo[] = {
    "SetVehicleNo\0\0onSetButtonClicked(int)\0"
    "onNumberButtonClicked(int)\0onTimerOut()\0"
};
...
int SetVehicleNo::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: onSetButtonClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: onNumberButtonClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: onTimerOut(); break;
        default: ;
        }
        _id -= 3;
    }
