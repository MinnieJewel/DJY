...
**
** Created: Tue Jun 2 11:35:59 2020
...
static const char qt_meta_stringdata_LoginPage[] = {
    "LoginPage\0\0onNumbersClick(int)\0"
    "on_btnBack_clicked()\0on_btnConfirm_clicked()\0"
};

const QMetaObject LoginPage::staticMetaObject = {
    { &MyBase::staticMetaObject, qt_meta_stringdata_LoginPage,
      qt_meta_data_LoginPage, 0 }
};
